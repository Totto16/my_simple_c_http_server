...
LibCInt comp_sem_init(SemaphoreType* sem, uint32_t value, bool shared) {
#ifdef __APPLE__
...
LibCInt comp_sem_wait(SemaphoreType* sem) {
...
LibCInt comp_sem_post(SemaphoreType* sem) {
...
LibCInt comp_sem_destroy(SemaphoreType* sem) {
